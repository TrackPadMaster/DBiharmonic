...
!				Dpm = (gammaP/90.d0)*(6.d0 - state*cosz2) ! TO BE CHANGED
!                Gpm = (twoninths)*gammaP*(1.d0 + state*cosz2)
!			    punch2 = ((2.d0*Dpm/Gpm)**(1.d0/2.d0))*gasdev(jdum) !check, TO FINISH
!               deltaP = deltaP + punch2
	    nstate = - nstate
	    state=dble(nstate)
!           print*, 'switch'
	 endif
